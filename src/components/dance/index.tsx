...
const Dance = () => {
  return (
    <main className='dance relative h-[300px] w-full overflow-hidden bg-[url(./assets/dance/DJ.png)] bg-cover bg-top bg-no-repeat md:h-[478px] lg:h-[630px] lg:bg-bottom 2xl:h-[1079px]'>
      <section className=''>
        <figure className='relative mx-auto w-[250px] md:w-[350px] 2xl:w-[700px]'>
      ...
      <figure className='absolute bottom-0 left-1/2 z-10 w-full -translate-x-1/2 2xl:w-[1727px]'>
