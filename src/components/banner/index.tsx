...
const Banner = () => {
  return (
    <main
      id='banner'
      className='banner relative h-[400px] w-full bg-[url(./assets/banner/banner-mb.png)] bg-cover bg-bottom bg-no-repeat lg:h-screen lg:bg-[url(./assets/banner/bg-banner.png)]'
    >
      <section className='relative z-50 mx-auto w-full pt-[90px] lg:w-[873px] lg:pt-[100px]'>
        <figure className='mx-auto w-[217px] lg:h-[280px] lg:w-[840px]'>
          <img src={logoBanner} alt='logobanner' />
        </figure>
        <p className='heading mx-auto w-[188px] text-base lg:mt-5 lg:w-[750px] lg:text-[64px]'>
          Play,Dance & Get Aidrop
        </p>
        <p className='lg"mt-[10px] mx-auto w-[204px] px-6 text-center text-xs font-bold text-[#fff] opacity-80 lg:w-[710px] lg:text-2xl lg:leading-[25px]'>
