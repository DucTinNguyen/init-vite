...
const NftMeme = () => {
  return (
    <section className='mx-auto w-full md:h-[500px] md:w-[600px] lg:h-[900px] lg:w-[1200px]'>
      <motion.h2
        initial={{
          opacity: 0,
          y: 70
        ...
        className='text-center text-xl font-bold uppercase leading-[60px] text-[#FFB800] md:text-[28px] lg:text-[60px]'
      >
        NFT meme
      </motion.h2>
      <Marquee className='mt-4 grid grid-cols-4 px-6 lg:mt-10 lg:px-0'>
        {memes.slice(0, 4).map((item) => {
          return (
            <figure className='mr-2 h-full w-[80px] md:mr-8 md:w-[125px] lg:mr-6 lg:w-full'>
